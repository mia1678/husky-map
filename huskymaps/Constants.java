...
public class Constants {
    ...
    public static final double ROOT_LAT_DIFF = Math.abs(ROOT_ULLAT - ROOT_LRLAT);  // 0.236897282
    public static final double ROOT_LON_DIFF = Math.abs(ROOT_LRLON - ROOT_ULLON); // 0.703125
    ...
    public static final double[] LON_PER_TILE = {
            ...
            ROOT_LON_DIFF / NUM_X_TILES_AT_DEPTH[7]   // 0.00274658203
    };
    ...
    public static final double[] LAT_PER_TILE = {
            ...
            ROOT_LAT_DIFF / NUM_Y_TILES_AT_DEPTH[7]   // 0.236897282 / 128 = 0.00185076002
    };
