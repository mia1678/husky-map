...
public class LinkedIntList {
    ...
    public static void firstToLast(LinkedIntList L) {
        if (L.front != null && L.front.next != null){
            // the list is empty or has just one element, its contents should not be modified.
            ListNode p = L.front;
    ...
    public static LinkedIntList concatenated(LinkedIntList A, LinkedIntList B) {
        ...
        LinkedIntList originalA = new LinkedIntList();
        ListNode a = A.front;
        ListNode b = B.front;
        if (a != null) {
            originalA.front = new ListNode(a.data, null);
            ListNode oa = originalA.front;
            while (a.next != null) {
                oa.next = new ListNode(a.next.data, null);
                oa = oa.next;
                a = a.next;
            }
            a.next = b;
            list.front = A.front;
            A.front = originalA.front;
            return list;
        } else {
          list.front = b;
          return list;
